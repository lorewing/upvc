...
<div class="row">
		...
		<h3 class="page-title"><?php echo lang('Edit Post'); ?> </h3>
                <?php 
                 ...
                 <hr>
					 ...
					 <?php foreach($rows as $r) : ?>
                    	  ...
                    	  <?php endforeach; ?>
                   		<?php echo form_open_multipart('/admincms/products/update_products'); 
				...
				<label><?php echo lang('Section') ; ?></label>
                            ...
                            <?php
                        	$query = $this->db->get_where('post_section',array('section_type'=>'products'));
		...
		<?php echo form_input(array('name' => 'related_tag', 'id' => 'related_tag',  'class' => 'form-control spinner','placeholder' => 'Industries Arrange', 'value' => $related_tag)); ?>
				...
				<div class="form-actions">		
                                    <?php echo form_submit(array('name' => 'edit_post','id' => 'edit_post', 'value' => 'Edit Products', 'class' => 'btn green uppercase'));
