<?php $this->load->view("admincms/includes2016/top.php"); ?>
 <h3 class="page-title"><?php echo lang('View Edit Services') ; ?> </h3>
  <hr>
		  ...
		  echo form_open('/admincms/products/update_section_arrange',$attributes); ?>
                   ...
                   <td><input type="checkbox" name="contentid[<?php echo $row->section_id;?>]" value="<?php echo $row->section_id;?>"></td>
                        ...
                        <td><a href="<?php echo base_url('admincms/products/edit_section/'.$row->section_id);?>"> Edit </a></td>
					    <td><a href="<?php echo base_url('admincms/products/delete_services/'.$row->section_id);?>"> Delete </a></td>
