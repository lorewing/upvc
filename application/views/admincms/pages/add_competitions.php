			...
			<div id="form_add">
				...
				<fieldset>
					...
					<legend>Add Competitions</legend>
                   		...
                   		<?php echo form_open_multipart('/admincms/pages/add_competitions'); 
...
<?php */?>
				<br />
						...
						echo form_submit(array('name' => 'add_project','id' => 'add_project', 'value' => 'Add Competitions', 'class' => 'button radius right small'));
