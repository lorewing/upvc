    ...
    <div id="content_container" class="row">
		...
		<div class="columns large-12">
			...
			<ul class="no-bullet inline-list" id="manage_nav">
				<li><a href="<?php echo base_url(); ?>admincms/pages/add_competitions/"><img src="<?php echo base_url(); ?>admin_view/images/icons/add.png"><span>Add competitions</span></a></li>
			</ul>	
		  ...
		  echo form_open('/admincms/pages/update_competitions_arrange',$attributes); 
		...
		<table id="example" class="display" cellspacing="0" width="100%">
                  ...
                  <tbody>
                   ...
                   <td><input type="checkbox" name="contentid[<?php echo $row->page_id;?>]" value="<?php echo $row->page_id;?>"></td>
                        ...
                        <td><a href="<?php echo base_url('admincms/pages/edit_competitions/'.$row->page_id);?>"> Edit </a></td>
					    <td><a href="<?php echo base_url('admincms/pages/delete_competitions/'.$row->page_id);?>"> Delete </a></td>
        ...
        <?php
						...
						echo form_submit(array('name' => 'sbm','id' => 'sbm', 'value' => 'Delete Selected Competitions', 'class' => 'button radius right small','onclick'=>"return con('Are you sure you want to delete the selected Competitions?')"));
