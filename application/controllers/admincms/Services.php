	...
	class Services extends CI_Controller
	{
		...
		function add_services_section()
		{
			...
			if($this->form_validation->run() == false)
			{
				...
				$this->load->view('admincms/services/add_services_section', $data);
			}
			else
			{
		...
		function add_services()
		{
			...
			if($this->form_validation->run() == false)
			{
				//echo "errors";
				$data['site_title'] = "Add Section";
				$this->load->view('admincms/services/add_services', $data);
			}
			else
			{
				$show_on_silder="";
				...
				if ( ! $this->upload->do_upload())
				{
					...
					$this->load->view('admincms/services/add_services', $error);
				}else{
		...
		{	
			...
			$this->session->set_flashdata('user_updated', '<p class=\'success\'Services was successfully deleted</p>');
		...
		{	
			...
			$this->load->view('admincms/services/editSection', $data);
