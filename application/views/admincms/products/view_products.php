<?php $this->load->view("admincms/includes2016/top.php"); ?>
 <h3 class="page-title"><?php echo lang('View Edit Post') ; ?> </h3>
  <hr>
		  ...
		  echo form_open('/admincms/products/update_products_arrange',$attributes); ?>
                   ...
                   <td><input type="checkbox" name="contentid[<?= $row->post_id;?>]" value="<?= $row->post_id;?>"></td>
                        ...
                        <td><a href="<?= base_url('admincms/products/edit_products/'.$row->post_id);?>"> Edit </a></td>
					    <td><a href="<?php echo base_url('admincms/products/delete_product/'.$row->post_id);?>"> Delete </a></td>
...
*/						
						echo form_submit(array('name' => 'sbm','id' => 'sbm', 'value' => lang('Delete Selected Products'), 'class' => 'btn green uppercase','onclick'=>"return con('Are you sure you want to delete the selected products?')"));
